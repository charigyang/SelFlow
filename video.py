...
self_sup_location = "/data/charig/SelFlow/Davis_val/from_pretrained" #train/from sintel
...
with open(data_list_file, 'rb') as f:
	for line in f:
		...
		self_sup = os.path.join(self_sup_location, "flow_fw_color_" + idx + ".png")
		self_unsup = os.path.join(self_unsup_location, "flow_fw_color_" + idx + ".png")
